                ...
                <div className="upload-content">
                    <Row>
                        <Col lg={4}>
                            ...
                            <p className="Description">Upload a document related to Sustainable Development Goals (SDGs) or paste its URL in order to analyse it (PDF, DOC, DOCX, HTML - max. size: 70K words). </p>
